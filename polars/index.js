...
switch (platform) {
  ...
  case 'win32':
    ...
    break
  case 'darwin':
    localFileExisted = existsSync(join(__dirname, 'nodejs-polars.darwin-universal.node'))
    try {
      if (localFileExisted) {
        nativeBinding = require('./nodejs-polars.darwin-universal.node')
      } else {
        nativeBinding = require('nodejs-polars-darwin-universal')
      }
      break
    } catch {}
    switch (arch) {
...
module.exports.argWhere = argWhere
...
module.exports.JsWhen = JsWhen
module.exports.JsThen = JsThen
module.exports.JsChainedWhen = JsChainedWhen
module.exports.JsChainedThen = JsChainedThen
...
module.exports.intRange = intRange
module.exports.intRanges = intRanges
...
module.exports.asStruct = asStruct
